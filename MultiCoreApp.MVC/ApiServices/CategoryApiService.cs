...
namespace MultiCoreApp.MVC.ApiServices
{
    public class CategoryApiService
    {
        ...
        public async Task<IEnumerable<CategoryDto>> GetAllAsync()
        {
            ...
            if (response.IsSuccessStatusCode)//Geri dönüş geldiyse
            {
        ...
        {
            var stringContent= new StringContent(JsonConvert.SerializeObject(catDto),Encoding.UTF8,"application/json");//tek bir satır gönderiyoruz
